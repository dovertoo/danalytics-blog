#base_ntwk_plot_season <- function(ntwk, edge_clr, node_clr)
...
base_ntwk_plot_season <- function(ntwk, edge_clr, node_clr){
     ...
     base_ntwk_season <- ggraph(ntwk, layout = "kk") +
          geom_edge_arc(arrow = arrow(length = unit(2, 'mm'), type = "closed"), 
